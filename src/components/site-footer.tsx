  ...
  return (
    <footer className="border-t border-border bg-primary text-primary-foreground">
      <div className="container-narrow grid gap-10 py-16 md:grid-cols-3">
        <div>
          <div className="font-display text-xl font-bold tracking-tight">HJALTE NYLANDER</div>
          <p className="mt-3 max-w-xs text-sm text-primary-foreground/70">
            Dansk DJ til din klub, festival eller andet event.
          </p>
        </div>
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            ...
            <li>
              <Link to="/tour" className="hover:opacity-70">
                Tour
              </Link>
            </li>
            <li>
        ...
        <div>
          <p className="eyebrow text-primary-foreground/60">Følg med</p>
          <div className="mt-4 flex gap-3">
            <a
              href="https://instagram.com/hjaltenylander"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://soundcloud.com/hjaltenylander"
              target="_blank"
              rel="noreferrer"
              className="rounded-full border border-primary-foreground/20 p-2 hover:bg-primary-foreground/10"
            >
